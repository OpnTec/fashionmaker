...
const QString hipWithAbdomenArcF_M = QStringLiteral("hip_with_abdomen_arc_f"); // D42
...
const QString bustToWaistF_M                  = QStringLiteral("bust_to_waist_f");                   // E14
const QString lowbustToWaistF_M               = QStringLiteral("lowbust_to_waist_f");                // E15
const QString ribToWaistSide_M                = QStringLiteral("rib_to_waist_side");                 // E16
const QString neckBackToHighbustB_M           = QStringLiteral("neck_back_to_highbust_b");           // E17
const QString neckBackToBustB_M               = QStringLiteral("neck_back_to_bust_b");               // E18
const QString highbustToWaistB_M              = QStringLiteral("highbust_to_waist_b");               // E19
const QString bustToWaistB_M                  = QStringLiteral("bust_to_waist_b");                   // E20
const QString lowbustToWaistB_M               = QStringLiteral("lowbust_to_waist_b");                // E21
const QString shoulderTipToArmfoldF_M         = QStringLiteral("shoulder_tip_to_armfold_f");         // E22
const QString neckSideToBustF_M               = QStringLiteral("neck_side_to_bust_f");               // E23
const QString neckSideToHighbustF_M           = QStringLiteral("neck_side_to_highbust_f");           // E24
const QString shoulderCenterToHighbustF_M     = QStringLiteral("shoulder_center_to_highbust_f");     // E25
const QString shoulderTipToArmfoldB_M         = QStringLiteral("shoulder_tip_to_armfold_b");         // E26
const QString neckSideToBustB_M               = QStringLiteral("neck_side_to_bust_b");               // E27
const QString neckSideToHighbustB_M           = QStringLiteral("neck_side_to_highbust_b");           // E28
const QString shoulderCenterToHighbustB_M     = QStringLiteral("shoulder_center_to_highbust_b");     // E29
const QString waistToHighhipF_M               = QStringLiteral("waist_to_highhip_f");                // E30
const QString waistToHipF_M                   = QStringLiteral("waist_to_hip_f");                    // E31
const QString waistToHighhipSide_M            = QStringLiteral("waist_to_highhip_side");             // E32
const QString waistToHighhipB_M               = QStringLiteral("waist_to_highhip_b");                // E33
const QString waistToHipB_M                   = QStringLiteral("waist_to_hip_b");                    // E34
const QString waistToHipSide_M                = QStringLiteral("waist_to_hip_side");                 // E35
const QString shoulderSlopeNeckSideAngle_M    = QStringLiteral("shoulder_slope_neck_side_angle");    // E36
const QString shoulderSlopeNeckSideLength_M   = QStringLiteral("shoulder_slope_neck_side_length");   // E37
const QString shoulderSlopeNeckBackAngle_M    = QStringLiteral("shoulder_slope_neck_back_angle");    // E38
const QString shoulderSlopeNeckBackHeight_M   = QStringLiteral("shoulder_slope_neck_back_height");   // E39
const QString shoulderSlopeShoulderTipAngle_M = QStringLiteral("shoulder_slope_shoulder_tip_angle"); // E40
// F
const QString shoulderLength_M                = QStringLiteral("shoulder_length");                     // F01
const QString shoulderTipToShoulderTipF_M     = QStringLiteral("shoulder_tip_to_shoulder_tip_f");      // F02
...
QStringList ListGroupE()
{
    const QStringList list = QStringList() << neckFrontToWaistF_M              // E01
                                           ...
                                           << bustToWaistF_M                   // E14
                                           << lowbustToWaistF_M                // E15
                                           << ribToWaistSide_M                 // E16
                                           << neckBackToHighbustB_M            // E17
                                           << neckBackToBustB_M                // E18
                                           << highbustToWaistB_M               // E19
                                           << bustToWaistB_M                   // E20
                                           << lowbustToWaistB_M                // E21
                                           << shoulderTipToArmfoldF_M          // E22
                                           << neckSideToBustF_M                // E23
                                           << neckSideToHighbustF_M            // E24
                                           << shoulderCenterToHighbustF_M      // E25
                                           << shoulderTipToArmfoldB_M          // E26
                                           << neckSideToBustB_M                // E27
                                           << neckSideToHighbustB_M            // E28
                                           << shoulderCenterToHighbustB_M      // E29
                                           << waistToHighhipF_M                // E30
                                           << waistToHipF_M                    // E31
                                           << waistToHighhipSide_M             // E32
                                           << waistToHighhipB_M                // E33
                                           << waistToHipB_M                    // E34
                                           << waistToHipSide_M                 // E35
                                           << shoulderSlopeNeckSideAngle_M     // E36
                                           << shoulderSlopeNeckSideLength_M    // E37
                                           << shoulderSlopeNeckBackAngle_M     // E38
                                           << shoulderSlopeNeckBackHeight_M    // E39
                                           << shoulderSlopeShoulderTipAngle_M; // E40
...
QStringList ListGroupF()
{
    const QStringList list = QStringList() << shoulderLength_M                 // F01
                                           << shoulderTipToShoulderTipF_M      // F02
                                           << acrossChestF_M                   // F03
...
QStringList ListGroupH()
{
    const QStringList list = QStringList() << shoulderTipToWaistFront_M        // H01
                                           ...
                                           << shoulderTipToWaistB_1inOffset_M; // H13
